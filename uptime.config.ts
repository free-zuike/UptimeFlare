...
const pageConfig: PageConfig = {
  ...
  links: [
    ...
    { link: 'https://blog.zuike.qzz.io/', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      method: 'HEAD',
      target: 'https://blog.zuike.qzz.io/',
      statusPageLink: 'https://blog.zuike.qzz.io/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: '文件托管',
      method: 'HEAD',
      target: 'https://cf-img.zuike.qzz.io/',
      statusPageLink: 'https://cf-img.zuike.qzz.io/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
